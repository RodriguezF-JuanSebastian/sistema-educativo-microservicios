...
public class Usuario implements UserDetails { //Declara la clase usuario que representara a cada fila de la tabla usuarios
    ...
    public Usuario(Long id, String nombre, String email, String password, String rol, String telefono, String direccion, LocalDate fechaNacimiento, Boolean estado) {
        this.id = id;
        this.nombre = nombre;
        this.email = email;
